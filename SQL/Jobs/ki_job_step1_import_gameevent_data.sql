...
SELECT r.id, r.server_id, r.session_id, r.sortie_id, r.ucid, r.date, r.event, r.player_name, r.player_side, 
       ...
       r.target_player_name, r.transport_unloaded_count, r.cargo 
FROM raw_gameevents_log r
LEFT JOIN session s 
